...
catContainer.addEventListener('click', async e =>{
    ...
    const manuCat = products.filter(product => product.category === id);
    ...
    displayProducts(manuCat, productCenter)
});
...
const letestCenter = document.querySelector('.latest-center')
...
window.addEventListener('DOMContentLoaded', async ()=>{
    ...
    displayProducts(latestProducts, letestCenter)
